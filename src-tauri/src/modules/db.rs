...
pub fn inject_token_to_path(
 ...
 crate::modules::logger::log_info(&format!(" Token : {:?}", db_path));
 ...
 crate::modules::logger::log_info("Token succeeded");
...
pub fn write_service_machine_id(service_machine_id: &str) -> Result<(), String> {
 ...
 crate::modules::logger::log_info(&format!("serviceMachineId write: {}", service_machine_id));
    Ok(())
}
