...
pub async fn exchange_code(code: &str, redirect_uri: &str) -> Result<TokenResponse, String> {
 crate::modules::logger::log_info(&format!("start Token , redirect_uri: {}", redirect_uri));
 ...
 crate::modules::logger::log_info(&format!("Token : {}", status));
 ...
 crate::modules::logger::log_info("Token succeeded, refresh_token");
        } else {
...
pub async fn ensure_fresh_token(
 ...
 crate::modules::logger::log_info("Token ，in progress: refresh...");
