...
<p align="center">
  <img src="resources/icon.png" width="128" height="128" alt="Mira AI Logo">
</p>
...
<p align="center">
  <!-- Mira AI: old Kiro image reference removed -->
</p>

<p align="center">
  <strong>A powerful multi-account management tool for Mira AI IDE</strong>
</p>
...
- Add, edit, and delete multiple Mira accounts
...
<!-- Mira AI: old Kiro Home screenshot reference removed -->

### Account Management
Manage all accounts, search, filter, batch operations, one-click switch.

<!-- Mira AI: old Kiro Account Management screenshot reference removed -->

### Machine ID Management
Manage device identifier, prevent account association bans, backup and restore.

<!-- Mira AI: old Kiro Machine ID Management screenshot reference removed -->
...
<!-- Mira AI: old Kiro API Proxy Service screenshot reference removed -->
...
<!-- Mira AI: old Kiro About screenshot reference removed -->
...
```bash
xattr -cr /Applications/Mira\ AI\ Manager.app
```
...
- **AppImage**: Add execute permission and run directly
  ```bash
  chmod +x mira-ai-manager-*.AppImage
  ./mira-ai-manager-*.AppImage
  ```
...
3. Mira AI IDE will use the new account after switching
