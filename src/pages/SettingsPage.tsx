          ...
          <div className="about-container">
            <div className="about-logo-section">
              <div className="app-icon-squircle">
                <img src={appLogo} alt="Mira Tools logo" className="app-icon-image" />
              </div>
            ...
            <div className="credits-list">
              <button className="credit-item" onClick={() => openLink('https://github.com/ProTechPh')}>
              ...
              <button className="credit-item" onClick={() => openLink('https://github.com/ProTechPh/Mira-AI')}>
                <div className="credit-icon" style={{ color: '#0f172a' }}><Github size={24} /></div>
                <h3>{t('settings.about.github')}</h3>
                <p>Mira-AI</p>
              </button>

              <button className="credit-item" onClick={() => openLink('https://github.com/ProTechPh/Mira-AI/blob/main/docs/DONATE.md')}>
              ...
              <button className="credit-item" onClick={() => openLink('https://github.com/ProTechPh/Mira-AI/issues')}>
