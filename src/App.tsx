...
function App() {
  ...
  const [wakeupReady, setWakeupReady] = useState(false);
  const [pathDetectReady, setPathDetectReady] = useState(false);
  ...
  useEffect(() => {
    if (themeReady && wakeupReady && pathDetectReady && minimumBootElapsed) {
      setBootReady(true);
    }
  }, [minimumBootElapsed, pathDetectReady, themeReady, wakeupReady]);
